...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $obraSeleccionada = $_POST["obraSeleccionada"];
    $seccionSeleccionada = $_POST["seccionSeleccionada"];
    $cantidadBoletos = $_POST["cantidadBoletos"];
    $metodoPago = $_POST["metodoPago"];

    // Consultar detalles de la obra desde la base de datos
    $sql = "SELECT * FROM ObrasTeatro WHERE id = $obraSeleccionada";
    ...
    if ($result->num_rows > 0) {
        ...
        $nombreObra = $row["obra"];
        $teatro = $row["teatro"];
        $precioBoleto = ($seccionSeleccionada == 1) ? $row["precioLuneta"] : $row["precioPalco"];
    ...
    <?php
        echo "<p><strong>Teatro seleccionado:</strong> $teatro</p>";
        echo "<p><strong>Obra Seleccionada:</strong> $nombreObra</p>";
        echo "<p><strong>Sección Seleccionada:</strong> " . (($seccionSeleccionada == 1) ? "Luneta" : "Palco") . "</p>";
